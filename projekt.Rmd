...
Izbral sem si primerjavo donosov delniških sektorjev
***
...
Uvozil sem podatke o delnicah z uporabo quantmod knjižnjice. Vsaka delnica ima svojo tabelo ki je v obliki *tidy data*.

1. `open` - cena ob odprtju
  - `high` - najvišja cena
  - `low` - najnižja cena
  - `close` - cena ob zaprtju
  - `volume` - volumen trgovanja
  - `adjusted` - prilagojena cena 
